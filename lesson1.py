...
while True: 
    coin = int(input("Insert a coin (1, 5, 10, 25 or 100:  )"))
    if coin != 1 and coin !=5 and coin !=10 and coin !=25 and coin !=100:
...
print("=================================")
print("Thanks for your purchase of", snack_price, "Rupees !!!")